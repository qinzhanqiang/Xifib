...
#define	MV40_DLL_VERSION_LOW 5
#define	MV40_DLL_VERSION_COMPILE 63
...
#define	MQ_SYS_VERSION_COMPILE		3
...
#define	API_INST_PACKAGE_VERSION_LOW 05
#define	API_INST_PACKAGE_COMPILE 63
